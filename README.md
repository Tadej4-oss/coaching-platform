...
Project Status
  ...
  The core functionality of the application is complete. The project was created as a portfolio project to demonstrate full-stack development with React, TypeScript, Node.js, Express and PostgreSQL. The codebase could be further refined in terms of cleanliness and overall architecture. However, since this is a portfolio project, I decided to move on to a new project where I can apply what I’ve learned while gaining hands-on experience with new concepts such as WebSockets and real-time communication. 
  
  The application code was written manually as part of a deliberate learning process. This allowed me to work through errors directly and develop a stronger understanding of concepts such as frontend vs. backend responsibilities, data flow, and handling undefined or unexpected values.
...
Coaching
  ...
  Client management(edit programs/exercises)
...
Individual routes MOSTLY use the appropriate HTTP methods such as GET, POST, PATCH, and DELETE.